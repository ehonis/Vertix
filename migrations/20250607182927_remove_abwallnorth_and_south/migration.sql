/*
  ...
  - The values [ABWallNorth,ABWallSouth] on the enum `Locations` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Locations_new" AS ENUM ('ropeNorthWest', 'ropeNorth', 'ropeNorthEast', 'ABWall', 'ropeSouthWest', 'ropeSouthEast', 'boulderSouth', 'boulderMiddle', 'boulderNorthCave', 'boulderNorthSlab');
