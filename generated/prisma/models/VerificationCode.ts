...
export type VerificationCodeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"phoneNumber" | "code" | "expiresAt" | "attempts" | "createdAt", ExtArgs["result"]["verificationCode"]>
...
export interface VerificationCodeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const verificationCodeWithPhoneNumberOnly = await prisma.verificationCode.findMany({ select: { phoneNumber: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many VerificationCodes and only return the `phoneNumber`
   * const verificationCodeWithPhoneNumberOnly = await prisma.verificationCode.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more VerificationCodes and only return the `phoneNumber`
   * const verificationCodeWithPhoneNumberOnly = await prisma.verificationCode.updateManyAndReturn({
   *   select: { phoneNumber: true },
   *   where: {
   *     // ... provide filter here
   *   },
