  ...
  return (
    <div className="w-full flex justify-center font-barlow">
      <div className="w-full flex flex-col items-center mt-5  gap-5">
        ...
        <div className="flex justify-between items-center p-5 w-[80%]">
        ...
        <div className="flex bg-slate-900 p-5 rounded-md w-[80%] items-center justify-center  overflow-x-scroll">
