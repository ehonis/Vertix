      ...
      <div className="max-w-md flex-col flex">
        ...
        <div className="mt-3 flex flex-col">
          <div className="flex flex-col gap-2 mb-2">
            <h1 className="font-barlow font-bold text-white text-4xl">Boulder League Manager</h1>
        ...
        <div className="flex flex-col gap-3">
          <div>
            <Suspense fallback={<ElementLoadingAnimation />}>
              <BoulderLeagueCompetitions compStatus={CompetitionStatus.IN_PROGRESS} />
            </Suspense>
          </div>
          <div>
            <Suspense fallback={<ElementLoadingAnimation />}>
              <BoulderLeagueCompetitions compStatus={CompetitionStatus.UPCOMING} />
            </Suspense>
          </div>
          <div>
            <Suspense fallback={<ElementLoadingAnimation />}>
              <BoulderLeagueCompetitions compStatus={CompetitionStatus.COMPLETED} />
            </Suspense>
          </div>
          <div>
            <Suspense fallback={<ElementLoadingAnimation />}>
              <BoulderLeagueCompetitions compStatus={CompetitionStatus.INACTIVE} />
            </Suspense>
          </div>

          <div>
            <Suspense fallback={<ElementLoadingAnimation />}>
              <BoulderLeagueCompetitions compStatus={CompetitionStatus.DEMO} />
            </Suspense>
          </div>
        </div>
      </div>
