        ...
        <div className="mt-3 flex flex-col">
          ...
          <div className="flex flex-col gap-2 mb-3">
            ...
            {compTypes.map(type => (
              <Link
                href={type.url}
                className="purple-button max-w-md grid grid-cols-3 font-barlow font-bold text-white p-3 rounded-sm  "
                key={type.text}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="text-2xl text-center whitespace-nowrap">{type.text}</p>
              </Link>
            ))}
          </div>
