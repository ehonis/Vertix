      ...
      <div className="bg-bg2 flex flex-col items-center justify-center p-5 w-96 rounded-lg shadow-md gap-3">
        <div className="flex gap-2">
          ...
          >
            <button
              type="submit"
              className="bg-bg1 w-max gap-3 items-center p-2 rounded-full text-white flex"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
        ...
        <div className="h-1 w-52 bg-white rounded" />
        <form
        ...
        >
          <input
            ...
            name="email"
            placeholder="Email"
            className="text-white bg-bg1 rounded px-2 py-1 font-barlow "
          />
          <button
            type="submit"
