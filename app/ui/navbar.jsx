...
import HamburgerMenu from './home/hamburger';
...
export default async function NavBar() {
  return (
    <>
      <nav className="sticky top-3 h-14 md:h-16 w-[95%] md:w-[75%] z-50 shadow-md bg-black grid md:px-5 px-3 md:grid-cols-3 grid-cols-2 items-center mt-3 rounded-md mx-auto">
        <Link
          href={'/'}
