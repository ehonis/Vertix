  ...
  return (
    <div className="flex px-4 gap-3">
      <div className="size-44 bg-bg2 rounded-lg justify-center items-center flex flex-col gap-4">
        <p className=" font-barlow gradient-text-purple-pink text-8xl drop-shadow-customBlack">
          {completions}
        </p>
        <p className="font-barlow text-white text-xl">Total Sends</p>
      </div>
      <div className="size-44 bg-bg2 rounded-lg justify-center items-center flex flex-col gap-4">
        <svg
        ...
        <p className="font-barlow text-white text-md text-center ">
